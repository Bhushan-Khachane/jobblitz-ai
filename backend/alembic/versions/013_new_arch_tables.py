...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending_login", "active", "expired", "error", name="browser_session_status"), server_default="pending_login"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("queued", "running", "success", "failed", "blocked", "skipped", name="application_run_status"), server_default="queued"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending", "approved", "rejected", "expired", name="approval_status"), server_default="pending"),
