...
export default function BillingPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 max-w-4xl">
      ...
      {/* Current Plan */}
      <Card className="border-indigo-200 bg-primary-500/5">
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h2 className="text-lg font-bold text-foreground">Free Plan</h2>
                <Badge className="bg-primary-500/15 text-primary-500">Current</Badge>
              </div>
              <p className="text-sm text-muted-foreground">5 applications per day · 1 job search</p>
            </div>
            <Button>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">You&apos;re on the Free plan — nothing to cancel!</p>
            </div>
